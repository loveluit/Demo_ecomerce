            ...
            autocomplete="off"> --}}
                ...
                <div class="wg-box">
                    <fieldset class="name">
                        ...
                        <input class="mb-10" type="text" placeholder="Enter product name" name="title" tabindex="0"
                    ...
                    <fieldset class="shortdescription">
                        ...
                        <textarea class="mb-10 ht-150" name="short_desp" placeholder="Short Description" tabindex="0" aria-required="true"
                            required=""></textarea>
                        <div class="text-tiny">Do not exceed 100 characters when entering the
                            product name.</div>
                    </fieldset>
                    ...
                    <fieldset class="description">
                        ...
                        <textarea class="mb-10" name="desp" placeholder="Description" tabindex="0" aria-required="true" required=""></textarea>
                        <div class="text-tiny">Do not exceed 100 characters when entering the
                            product name.</div>
                    </fieldset>
                </div>
                            ...
                            <div id="galUpload" class="item up-load">
                                <label class="uploadfile" for="gFile">
                                    ...
                                    <span class="text-tiny">Drop your images here or select <span class="tf-color">click
                                            to browse</span></span>
                                    <input type="file" id="gFile" name="priview" accept="image/*"
                                        multiple="">
                                </label>
                            </div>
                        </div>
