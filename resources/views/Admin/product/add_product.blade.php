            ...
            <div class="wg-box">
                <fieldset class="name">
                    ...
                    <input class="mb-10" type="text" placeholder="Enter product name"
                        name="title" tabindex="0" value="" aria-required="true" required="">
                ...
                <fieldset class="shortdescription">
                    ...
                    <textarea class="mb-10 ht-150" name="short_desp"
                ...
                <fieldset class="description">
                    ...
                    <textarea class="mb-10" name="desp" placeholder="Description"
                ...
                <div class="cols gap22">
                    <fieldset class="name">
                        ...
                        <input class="mb-10" type="text" placeholder="Enter regular price"
                            name="regular_price"  value="" aria-required="true"
                            required="">
                    </fieldset>
                    <fieldset class="name">
                        ...
                        <input class="mb-10" type="text" placeholder="Enter sale price"
                            name="sale_price"  value="" aria-required="true"
                            required="">
                    </fieldset>
                </div>
