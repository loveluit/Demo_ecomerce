...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('back_end') }}/css/animate.min.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('back_end') }}/css/animation.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('back_end') }}/css/bootstrap.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('back_end') }}/css/bootstrap-select.min.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('back_end') }}/css/style.css">
    <link rel="stylesheet" href="{{ asset('back_end') }}/font/fonts.css">
    <link rel="stylesheet" href="{{ asset('back_end') }}/icon/style.css">
    <link rel="shortcut icon" href="{{ asset('back_end') }}/images/favicon.ico">
                            ...
                            <ul class="menu-list">
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="sub-menu-item">
                                            <a href="{{ route('product.view') }}" class="">
                                                <div class="text">Products</div>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <div class="popup-wrap user type-header">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content"
                                            ...
                                            <li>
                                                <a href="{{ route('profile.name') }}" class="user-item">
                                                    <div class="icon">
                                                        <i class="icon-user"></i>
                                                    </div>
