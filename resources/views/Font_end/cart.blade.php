                                ...
                                <tr>
                                    <td>
                                        <div class="shopping-cart__product-item">
                                            <img loading="lazy"
                                                src="{{ asset('uploads/product') }}/{{ $cart->rel_to_product->product_image }}"
                                                width="120" height="120" alt="" />
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shopping-cart__product-item__detail">
                                            <h4>{{ $cart->rel_to_product->title }}</h4>
                                    ...
                                    <td>
                                        <span
                                            class="shopping-cart__product-price">{{ $cart->rel_to_product->regular_price }}TK</span>
                                    </td>
                                    <td>
                                        <div class="qty-control position-relative">
                                            <input type="number" name="quantity" value="{{ $cart->quantity }}"
                                                min="{{ $cart->quantity }}" class="qty-control__number text-center">
                                    ...
                                    <td>
                                        <span
                                            class="shopping-cart__subtotal">{{ $cart->rel_to_product->sale_price }}TK</span>
                                    </td>
                                    <td>
