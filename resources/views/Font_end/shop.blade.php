                        ...
                        <div class="swiper-slide">
                            <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                                ...
                                <div class="slide-split_media position-relative">
                                    <div class="slideshow-bg" style="background-color: #f5e6e0;">
                                        <img loading="lazy"
                                            src="{{ asset('font_end') }}/assets/images/shop/shop_banner3.jpg"
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <a href="details.html"><img loading="lazy"
                                                    src="{{ asset('font_end') }}/assets/images/products/product_1.jpg"
                                                    width="330" height="400" alt="Cropped Faux leather Jacket"
                                                    class="pc__img"></a>
                                        </div>
                                        <div class="swiper-slide">
                                            <a href="details.html"><img loading="lazy"
                                                    src="{{ asset('font_end') }}/assets/images/products/product_1-1.jpg"
                                                    width="330" height="400" alt="Cropped Faux leather Jacket"
                                                    class="pc__img"></a>
                                        </div>
                                    </div>
                            ...
                            <div class="pc__img-wrapper">
                                <div class="swiper-container background-img js-swiper-slider"
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <a href="details.html"><img loading="lazy"
                                                    src="{{ asset('font_end') }}/assets/images/products/product_2.jpg"
                                                    width="330" height="400" alt="Cropped Faux leather Jacket"
                                                    class="pc__img"></a>
                                        </div>
                                        <div class="swiper-slide">
                                            <a href="details.html"><img loading="lazy"
                                                    src="{{ asset('font_end') }}/assets/images/products/product_2-1.jpg"
                                                    width="330" height="400" alt="Cropped Faux leather Jacket"
                                                    class="pc__img"></a>
                                        </div>
                                    </div>
                            ...
                            <div class="pc__img-wrapper">
                                <div class="swiper-container background-img js-swiper-slider"
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <a href="details.html"><img loading="lazy"
                                                    src="{{ asset('font_end') }}/assets/images/products/product_3.jpg"
                                                    width="330" height="400" alt="Cropped Faux leather Jacket"
                                                    class="pc__img"></a>
                                        </div>
                                        <div class="swiper-slide">
                                            <a href="details.html"><img loading="lazy"
                                                    src="{{ asset('font_end') }}/assets/images/products/product_3-1.jpg"
                                                    width="330" height="400" alt="Cropped Faux leather Jacket"
                                                    class="pc__img"></a>
                                        </div>
                                    </div>
                            ...
                            <div class="pc__img-wrapper">
                                <div class="swiper-container background-img js-swiper-slider"
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <a href="details.html"><img loading="lazy"
                                                    src="{{ asset('font_end') }}/assets/images/products/product_4.jpg"
                                                    width="330" height="400" alt="Cropped Faux leather Jacket"
                                                    class="pc__img"></a>
                                        </div>
                                        <div class="swiper-slide">
                                            <a href="details.html"><img loading="lazy"
                                                    src="{{ asset('font_end') }}/assets/images/products/product_4-1.jpg"
                                                    width="330" height="400" alt="Cropped Faux leather Jacket"
                                                    class="pc__img"></a>
                                        </div>
                                    </div>
                            ...
                            <div class="pc__img-wrapper">
                                <div class="swiper-container background-img js-swiper-slider"
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <a href="details.html"><img loading="lazy"
                                                    src="{{ asset('font_end') }}/assets/images/products/product_5.jpg"
                                                    width="330" height="400" alt="Cropped Faux leather Jacket"
                                                    class="pc__img"></a>
                                        </div>
                                        <div class="swiper-slide">
                                            <a href="details.html"><img loading="lazy"
                                                    src="{{ asset('font_end') }}/assets/images/products/product_5-1.jpg"
                                                    width="330" height="400" alt="Cropped Faux leather Jacket"
                                                    class="pc__img"></a>
                                        </div>
                                    </div>
                            ...
                            <div class="pc__img-wrapper">
                                <div class="swiper-container background-img js-swiper-slider"
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <a href="details.html"><img loading="lazy"
                                                    src="{{ asset('font_end') }}/assets/images/products/product_6.jpg"
                                                    width="330" height="400" alt="Cropped Faux leather Jacket"
                                                    class="pc__img"></a>
                                        </div>
                                        <div class="swiper-slide">
                                            <a href="details.html"><img loading="lazy"
                                                    src="{{ asset('font_end') }}/assets/images/products/product_6-1.jpg"
                                                    width="330" height="400" alt="Cropped Faux leather Jacket"
                                                    class="pc__img"></a>
                                        </div>
                                    </div>
                            ...
                            <div class="pc__img-wrapper">
                                <div class="swiper-container background-img js-swiper-slider"
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <a href="details.html"><img loading="lazy"
                                                    src="{{ asset('font_end') }}/assets/images/products/product_7.jpg"
                                                    width="330" height="400" alt="Cropped Faux leather Jacket"
                                                    class="pc__img"></a>
                                        </div>
                                        <div class="swiper-slide">
                                            <a href="details.html"><img loading="lazy"
                                                    src="{{ asset('font_end') }}/assets/images/products/product_7-1.jpg"
                                                    width="330" height="400" alt="Cropped Faux leather Jacket"
                                                    class="pc__img"></a>
                                        </div>
                                    </div>
                            ...
                            <div class="pc__img-wrapper">
                                <div class="swiper-container background-img js-swiper-slider"
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <a href="details.html"><img loading="lazy"
                                                    src="{{ asset('font_end') }}/assets/images/products/product_8.jpg"
                                                    width="330" height="400" alt="Cropped Faux leather Jacket"
                                                    class="pc__img"></a>
                                        </div>
                                        <div class="swiper-slide">
                                            <a href="details.html"><img loading="lazy"
                                                    src="{{ asset('font_end') }}/assets/images/products/product_8-1.jpg"
                                                    width="330" height="400" alt="Cropped Faux leather Jacket"
                                                    class="pc__img"></a>
                                        </div>
                                    </div>
                            ...
                            <div class="pc__img-wrapper">
                                <div class="swiper-container background-img js-swiper-slider"
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <a href="details.html"><img loading="lazy"
                                                    src="{{ asset('font_end') }}/assets/images/products/product_9.jpg"
                                                    width="330" height="400" alt="Cropped Faux leather Jacket"
                                                    class="pc__img"></a>
                                        </div>
                                        <div class="swiper-slide">
                                            <a href="details.html"><img loading="lazy"
                                                    src="{{ asset('font_end') }}/assets/images/products/product_9-1.jpg"
                                                    width="330" height="400" alt="Cropped Faux leather Jacket"
                                                    class="pc__img"></a>
                                        </div>
                                    </div>
