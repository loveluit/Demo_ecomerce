                            ...
                            @foreach ($categorys as $category)
                                <div class="swiper-slide">
                                    ...
                                    <div class="text-center">
                                        <a href="#"
                                            class="menu-link fw-medium">{{ $category->category_name }}<br />Tops</a>
                                    </div>
                                </div>
                            @endforeach
            ...
            <section class="hot-deals container">
                ...
                < class="row">
                    ...
                    <div class="col-md-6 col-lg-8 col-xl-80per">
                        <div class="position-relative">
                            <div class="swiper-container js-swiper-slider"
                                data-settings='{ "autoplay"
                        : { "delay" : 5000 }, "slidesPerView" : 4, "slidesPerGroup" : 4, "effect" : "none" , "loop" :
                        false, "breakpoints" : { "320" : { "slidesPerView" : 2, "slidesPerGroup" : 2, "spaceBetween" : 14
                        }, "768" : { "slidesPerView" : 2, "slidesPerGroup" : 3, "spaceBetween" : 24 }, "992" :
                        { "slidesPerView" : 3, "slidesPerGroup" : 1, "spaceBetween" : 30, "pagination" : false }, "1200" :
                        { "slidesPerView" : 4, "slidesPerGroup" : 1, "spaceBetween" : 30, "pagination" : false } } }'>
                                <div class="swiper-wrapper">
                            ...
                            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                                ...
                                <div class="pc__info position-relative">
                                    <h6 class="pc__title"><a
                                            href="{{ route('products.detail', $product->id) }}">{{ $product->title }}</a>
                                    </h6>
                                    <div class="product-card__price d-flex align-items-center">
                                        <span class="money price text-secondary">{{ $product->regular_price }}TK</span>
                                    </div>
